        ...
        <div className="px-16 py-4 mt-2">
            <div className="latest-poject-heading">
                ...
                <div className="latest-project-cards flex gap-6 mt-10">
                    <div className="latest-proj-left w-1/3 border bg-white pb-8">
                        <div className="latest-proj-img border">
                        </div>
                    ...
                    <div className="latest-proj-left w-1/3 border bg-white pb-8">
                        <div className="latest-proj-img-two border">
                        </div>
                        <h1 className="mt-4 text-center font-bold text-lg">
                            Project Two
                        </h1>
                    ...
                    <div className="latest-proj-left w-1/3 border bg-white pb-8">
                        <div className="latest-proj-img-three border">   
                        </div>
                        <h1 className="mt-4 text-center font-bold text-lg">
                            Project Three
                        </h1>
