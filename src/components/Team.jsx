...
const Team = () => {
    return(
        <div className="team-main border py-6 px-12">
            ...
            <div className="mt-10 flex gap-6 px-4">
                <div className="team-item team-one w-1/4 border">
                    <div className="team-img-one rounded-full border">
                ...
                <div className="team-item team-two w-1/4 border">
                    <div className="team-img-two rounded-full border"></div>
                ...
                <div className="team-item team-three w-1/4 border">
                    <div className="team-img-three rounded-full border"></div>
                ...
                <div className="team-item team-four w-1/4 border">
                    <div className="team-img-four rounded-full border"></div>
